...
class JobInput extends Component {
  ...
  // changes the parent (ie the containing employment section) state to reflect these changes in its displayData, so it can pass that change on to the CV upon submission
